...
# Usage: irm https://raw.githubusercontent.com/AkaraChen/yoi/main/install-yoi-server.ps1 | iex
...
$Tmp = Join-Path ([System.IO.Path]::GetTempPath()) ("yoi-server-install-" + [guid]::NewGuid().ToString("N"))
