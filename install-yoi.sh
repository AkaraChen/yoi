...
# Usage: curl -fsSL https://raw.githubusercontent.com/AkaraChen/yoi/main/install-yoi.sh | sh
set -eu
...
Darwin) os=darwin ;;
MINGW*|MSYS*|CYGWIN*)
	die "Windows: use install-yoi.ps1 (irm https://raw.githubusercontent.com/AkaraChen/yoi/main/install-yoi.ps1 | iex)"
	;;
