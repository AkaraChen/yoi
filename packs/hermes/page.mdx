...
一个装在你自己机器上的对话入口。你带着问题进来，它用你选的模型回答，并在需要时调用工具。上游是 [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent)，说明在 [官方入门页](https://hermes-agent.nousresearch.com/docs/getting-started/quickstart)。
